...
import static vlad110kg.news.aggregator.bot.client.message.template.TemplateUtils.DIR_BACK;
import static vlad110kg.news.aggregator.bot.client.message.template.TemplateUtils.DIR_NEXT;
import static vlad110kg.news.aggregator.bot.client.message.template.TemplateUtils.DIR_PREV;
import static vlad110kg.news.aggregator.bot.client.message.template.TemplateUtils.LIST_SUBCATEGORY;
import static vlad110kg.news.aggregator.bot.client.message.template.TemplateUtils.PICK;
import static vlad110kg.news.aggregator.bot.client.message.template.TemplateUtils.name;
