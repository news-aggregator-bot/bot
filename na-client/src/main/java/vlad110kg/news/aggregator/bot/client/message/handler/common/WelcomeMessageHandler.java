...
import vlad110kg.news.aggregator.bot.client.message.handler.list.CategoryListMessageHandler;
...
import vlad110kg.news.aggregator.bot.client.service.IReaderService;

import java.util.Arrays;

import static vlad110kg.news.aggregator.bot.client.message.template.TemplateUtils.WELCOME_LIST_CATEGORY;
