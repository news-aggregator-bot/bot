...
@Component
public class PickedCommonSubCategoryListMessageHandler extends AbstractSubCategoryListMessageHandler {
    ...
    protected Tuple2<String, Map<String, Object>> msgTextData(CategoryDto parent, int page) {
        return Tuples.of(LIST_PICKED_CATEGORIES, TemplateUtils.params("category", parent.getName(), "page", page));
    }
}
